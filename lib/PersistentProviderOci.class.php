...
class f_persistentdocument_PersistentProviderOci extends f_persistentdocument_PersistentProvider
{
	...
	{
		if ($properties['tableNameOci'])
		{
			return $properties['tableNameOci'];
		}
		return parent::generateTableName($properties);
	}
	...
	{
		if ($properties['dbMappingOci'])
		{
			return $properties['dbMappingOci'];
		}
		return parent::generateFieldName($properties);
	}
